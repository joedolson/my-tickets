...
* Security: Authenticated XSS Vulnerability in `remaining` shortcode. Props @Muhammad Yudha through Patchstack.

= 2.0.22 =

* Bug fix: "Only singular pages" option check as a boolean, but was actually a string.
...
* Bug fix: Inconsistent return behavior in `mt_save_data()`. Props https://github.com/ben-abrams
...
* Bug fix: Mismatched logic between admin and front-end for My Calendar events when disabling tickets.
