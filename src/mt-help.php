			...
			<div class="metabox-holder">
				...
				<div class="ui-sortable meta-box-sortables">
					...
					<div class="postbox">
						...
						<div class="inside">
							<dl>
								<dt><?php _e( 'What is the difference between "Seating Sections", "Audience Types", and "Events" ticket counting?', 'my-tickets' ); ?></dt>
								<dd><?php _e( 'Whether it matters which group a ticket is purchased in. If you\'re selling tickets based on the purchaser (Adult, Child, etc.), it doesn\'t matter which group it\'s in. You have 250 tickets, and it\'s perfectly plausible for all 250 to be in one category. Ticket sales are all counted as one total. You have a specific total number of tickets, and whichever type of ticket is sold, the number is subtracted from the total number of tickets. With separate seating sections (Gallery, Balcony, etc.), it <strong>does</strong> matter which group a ticket is sold from. You have only 50 tickets in Section A, but 100 in Section B. If you were to sell 100 tickets for Section A, you\'d have a serious problem. With "Events" counting, each ticket type is for a different date, and is only valid for that date.', 'my-tickets' ); ?></dd>
